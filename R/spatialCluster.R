...
#' set.seed(149)
#' sce <- exampleSCE()
#' sce <- spatialCluster2(sce, 7, nrep=100, burn.in=10)
#' 
...
#' 
#' @export
#' @rdname spatialCluster2
spatialCluster2 <- function(sce, q, use.dimred = "PCA", d = 15,
